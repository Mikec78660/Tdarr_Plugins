...
var plugin = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    var lib, keepRelativePath, allowCopyFallback, outputDirectory, originalFileName, newContainer, outputPath, subStem, outputFilePath, fs, err_1, fileMoveOrCopy, shellErr_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                allowCopyFallback = args.inputs.allowCopyFallback;
                ...
                outputFilePath = (0, normJoinPath_1.default)({
                    upath: args.deps.upath,
                    paths: [
                        outputPath,
                ...
                args.jobLog("Output path: ".concat(outputFilePath));
            ...
            case 1:
                ...
                return [4 /*yield*/, fs.rename(args.inputFileObj._id, outputFilePath)];
            case 2:
                _a.sent();
            ...
            case 3:
                err_1 = _a.sent();
                args.jobLog("Atomic rename failed: ".concat(err_1.message));
                if (!(err_1.code === 'EXDEV' || err_1.message.toLowerCase().includes('cross-device'))) return [3 /*break*/, 6];
                ...
                fileMoveOrCopy = require('../../../../FlowHelpers/1.0.0/fileMoveOrCopy').default;
                return [4 /*yield*/, fileMoveOrCopy({
                        operation: 'move',
            ...
            case 6:
                ...
                try {
                    require('child_process').execSync("mv \"".concat(args.inputFileObj._id, "\" \"").concat(outputFilePath, "\""));
                    args.jobLog('Shell move completed successfully.');
                }
                catch (shellErr_1) {
                    args.jobLog("Shell move also failed: ".concat(shellErr_1.message));
                    throw err_1; // throw original error
                }
                _a.label = 7;
