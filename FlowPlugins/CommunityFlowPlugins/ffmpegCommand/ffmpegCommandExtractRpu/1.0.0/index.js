...
var plugin = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    var lib, execSync, doviToolPath, inputPath, workDir, rpuOutputPath, cmd;
    return __generator(this, function (_a) {
        ...
        rpuOutputPath = "".concat(workDir, "/safe_RPU.bin");
        args.jobLog("Extracting RPU to ".concat(rpuOutputPath));
        cmd = "\"".concat(doviToolPath, "\" -c extract-rpu \"").concat(inputPath, "\" -o \"").concat(rpuOutputPath, "\"");
        try {
            execSync(cmd);
            ...
            args.jobLog("Error extracting RPU: ".concat(err.message));
            throw new Error("RPU extraction failed: ".concat(err.message));
        }
        return [2 /*return*/, {
